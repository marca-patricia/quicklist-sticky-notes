...
'listRestored': 'Lista restaurada',
    ...
    // Phase 6: PWA, Native Features, Analytics
    'appInstalled': 'App instalado',
    'appInstalledDesc': 'QuickList foi adicionado à sua tela inicial',
    'installApp': 'Instalar App',
    'shareApp': 'Compartilhar App',
    'shareAppText': 'Confira o QuickList - Lista de tarefas simples e offline!',
    'shareAppDescription': 'Compartilhe o QuickList com seus amigos',
    'sharedSuccessfully': 'Compartilhado com sucesso',
    'sharedSuccessfullyDesc': 'Link compartilhado via sistema nativo',
    ...
    'notificationsDeniedDesc': 'Você pode ativar nas configurações do navegador',
    ...
    'notificationsErrorDesc': 'Erro ao configurar notificações',
    'testNotificationBody': 'As notificações estão funcionando!',
    'exportData': 'Exportar Dados',
    'importData': 'Importar Dados',
    'dataExported': 'Dados Exportados',
    'dataExportedDesc': 'Backup salvo com sucesso',
    'dataImported': 'Dados Importados',
    'dataImportedDesc': 'Dados restaurados com sucesso',
    'exportError': 'Erro na Exportação',
    'exportErrorDesc': 'Falha ao exportar dados',
    'importError': 'Erro na Importação',
    'importErrorDesc': 'Arquivo de backup inválido',
    ...
    'offlineModeDesc': 'Suas alterações serão sincronizadas quando voltar online',
    ...
    'dataManagementDesc': 'Gerencie e sincronize seus dados entre dispositivos',
    ...
    'yes': 'Sim',
    'no': 'Não',
    'statisticsPageDesc': 'Visualize estatísticas detalhadas de uso, analytics e gerencie dados do QuickList',
...
'listRestored': 'List restored',
    ...
    'appInstalledDesc': 'QuickList has been added to your home screen',
    'installApp': 'Install App',
    'shareApp': 'Share App',
    'shareAppText': 'Check out QuickList - Simple and offline task list!',
    'shareAppDescription': 'Share QuickList with your friends',
    'sharedSuccessfully': 'Shared Successfully',
    'sharedSuccessfullyDesc': 'Link shared via native system',
    'copiedToClipboard': 'Copied to Clipboard',
    'copyLink': 'Copy Link',
    'enableNotifications': 'Enable Notifications',
    'notificationsEnabled': 'Notifications Enabled',
    'notificationsEnabledDesc': 'You will receive task reminders',
    'notificationsDenied': 'Notifications Denied',
    'notificationsDeniedDesc': 'You can enable them in browser settings',
    ...
    'notificationsErrorDesc': 'Error setting up notifications',
    'testNotificationBody': 'Notifications are working!',
    'exportData': 'Export Data',
    'importData': 'Import Data',
    'dataExported': 'Data Exported',
    'dataExportedDesc': 'Backup saved successfully',
    'dataImported': 'Data Imported',
    'dataImportedDesc': 'Data restored successfully',
    'exportError': 'Export Error',
    'exportErrorDesc': 'Failed to export data',
    'importError': 'Import Error',
    'importErrorDesc': 'Invalid backup file',
    ...
    'offlineModeDesc': 'Your changes will sync when you come back online',
    ...
    'dataManagementDesc': 'Manage and sync your data across devices',
    ...
    'yes': 'Yes',
    'no': 'No',
    'statisticsPageDesc': 'View detailed usage statistics, analytics and manage QuickList data',
    'overview': 'Overview',
